...
export const PROCESS_UPGRADE_DETAILS: Record<UpgradeId, ProcessUpgradeDetails> = {
  drone_speed: {
    ...
    fullName: "Process Priority Service",
    tag: "STATUS: RUNNING // ROUTINE: SCAN",
    description: "Allocates higher CPU execution priority to active diagnostic threads, accelerating sector sweep velocity.",
  },
  cable_length: {
    shortLabel: "Bus Reach",
    fullName: "Bus Reach Extension",
    tag: "STATUS: RUNNING // ROUTINE: FILTER",
    description: "Extends maximum signal range of process bus scanning threads across memory sectors.",
  },
  purge_radius: {
    shortLabel: "Quarantine",
    fullName: "Quarantine Subroutine",
    tag: "STATUS: RUNNING // ROUTINE: ISOLATE",
    description: "Expands quarantine boundary, triggering wider chain reaction purges on corrupted memory blocks.",
  },
  core_overclock: {
    shortLabel: "Kernel OC",
    fullName: "Kernel Overclock Subroutine",
    tag: "STATUS: RUNNING // ROUTINE: OVERDRIVE",
    description: "Unlocks emergency Overclock [E] mode, doubling process refresh rates and deploying firewall buffers.",
  },
  overclock_dampener: {
    shortLabel: "Thermal Comp",
    fullName: "Thermal Compensator Service",
    tag: "STATUS: RUNNING // ROUTINE: DISSIPATION",
    description: "Installs heat dissipation sinks that cut Overclock thermal throttle duration in half (4.0s → 2.0s).",
  },
  bit_scavenger: {
    shortLabel: "Mem Defrag",
    fullName: "Memory Defragmenter Service",
    tag: "STATUS: RUNNING // ROUTINE: RECOVERY",
    description: "Defragments freed memory pages during purges, giving a chance to recover double Bits capacity.",
  },
  shield_buffer: {
    shortLabel: "Firewall",
    fullName: "Firewall Buffer Service",
    tag: "STATUS: RUNNING // ROUTINE: PROTECTION",
    description: "Strengthens firewall overshield buffer capacity gained from border link purges (+40 HP capacity per tier).",
  },
  targeting_subroutines: {
    shortLabel: "Heuristics",
    fullName: "Behavior Analysis Heuristics",
    tag: "STATUS: RUNNING // ROUTINE: PURGE_PRIORITY",
    description: "Enhances process auto-target routines (L1 prioritizes Sector Locks; L2 prioritizes Rootkit Overrides).",
  },
};
